...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\EntraAuth\functions", "$global:testroot\..\EntraAuth\internal\functions"),
	
	[string]
	$ModuleName = "EntraAuth",
...
$CommandPath = @(
    "$global:testroot\..\EntraAuth\functions"
    "$global:testroot\..\EntraAuth\internal\functions"
)
