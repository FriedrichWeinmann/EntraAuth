...
Remove-Module EntraAuth -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\EntraAuth\EntraAuth.psd1"
Import-Module "$PSScriptRoot\..\EntraAuth\EntraAuth.psm1" -Force
